...
<h2>Students with Zero Arrears</h2>
<body bgcolor="WHITE">
<?php
	include "dbconn.php";
?>
...
$query = mysql_query("select apply.*,donate.* from apply LEFT OUTER JOIN donate ON apply.last= donate.student_Lname WHERE donate.Amount !='0'")or die(mysql_error());
